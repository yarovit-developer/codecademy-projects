...
let early = true;
let age = 17; // Change the age to test different scenarios

// Check if the runner has registered in advance and is over 18
if (early && age > 18) {
  raceNumber += 1000;
}

// Check the conditions to determine the race time
if (early && age > 18) {
